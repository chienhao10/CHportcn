...
namespace Slutty_ryze
{
    internal class MenuManager
    {
        ...
        private static void HumanizerMenu()
        {
            ...
            humanizerMenu.Add("minCreepHPOffset",
                new Slider("Minimum HP for a Minion to Have Before CSing Damage >= HP+(%)", 5, 0, 25));
            humanizerMenu.Add("maxCreepHPOffset",
                new Slider("Maximum HP for a Minion to Have Before CSing Damage >= HP+(%)", 15, 0, 25));
        ...
        {
            laneMenu = _config.AddSubMenu("Lane Settings", "lane");
            ...
            jungleMenu = _config.AddSubMenu("Jungle Clear Settings", "jg");
            ...
            lastMenu = _config.AddSubMenu("Last Hit Settings", "lah");
