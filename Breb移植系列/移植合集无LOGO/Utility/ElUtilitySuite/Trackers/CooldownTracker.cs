...
namespace ElUtilitySuite.Trackers
{
    ...
    internal class CoolDownTimers : IPlugin
    {
        ...
        {
            var drawingMenu = rootMenu.AddSubMenu("技能计时", "cdtracker");
            {
                drawingMenu.Add("OffsetTop", new Slider("上移动", 0));
                drawingMenu.Add("OffsetLeft", new Slider("左移动", 0));
                drawingMenu.Add("Outline", new CheckBox("外框"));
