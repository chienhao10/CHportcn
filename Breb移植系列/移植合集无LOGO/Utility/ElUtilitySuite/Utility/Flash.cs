namespace ElUtilitySuite.Utility
{
    ...
    internal class Flash : IPlugin
    {
        ...
        public void CreateMenu(Menu rootMenu)
        {
            ...
            flashM.Add("WallCheck", new CheckBox("检测墙壁", false));
            flashM.Add("IgniteCheck", new CheckBox("无视检测", false));
            flashM.Add("Extend", new CheckBox("延长距离", false));
            flashM.Add("Enabled", new CheckBox("开启", false));
        }
