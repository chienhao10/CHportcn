...
namespace AutoSharp.Plugins
{
    public class Karthus : PluginBase
    {
        ...
        public Karthus()
        {
            ...
            E = new LeagueSharp.Common.Spell(SpellSlot.E, 505);
            R = new LeagueSharp.Common.Spell(SpellSlot.R, 20000f);
        ...
        private void Combo()
        {
            ...
            CastW(TargetSelector.GetTarget(W.Range, DamageType.Magical), 20);
        ...
        {
            return Math.Max(30, (1f - (Player.LSDistance(target) / Q.Range)) * SpellQWidth);
        }
        ...
        {
            return Math.Max(70, (1f - (Player.LSDistance(target) / W.Range)) * SpellWWidth);
        }
        ...
        public void UltKs()
        {
            ...
            {
                if (R.IsReady() && Player.LSDistance(target) <= R.Range && R.IsKillable(target) && (Player.IsZombie || Player.LSCountEnemiesInRange(1000) < 1))
                {
                    R.Cast();
                }
            }
