...
{public class Zyra : PluginBase
    {
        public Zyra()
        {
            ...
            W = new LeagueSharp.Common.Spell(SpellSlot.W, 825);
            E = new LeagueSharp.Common.Spell(SpellSlot.E, 1100);
            R = new LeagueSharp.Common.Spell(SpellSlot.R, 700);
            Passive = new LeagueSharp.Common.Spell(SpellSlot.Q, 1470);
        ...
        private LeagueSharp.Common.Spell Passive { get; set; }
        ...
        public override void OnUpdate(EventArgs args)
        {
            try
            {
                ...
                if (ComboMode)
                {
                    ...
                    {
                        R.CastIfWillHit(Target, ComboConfig["Combo.R.Count"].Cast<Slider>().CurrentValue);
                    }
                }
