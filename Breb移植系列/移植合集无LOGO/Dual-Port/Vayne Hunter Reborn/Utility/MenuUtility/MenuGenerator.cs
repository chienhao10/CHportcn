...
namespace VayneHunter_Reborn.Utility.MenuUtility
{
    class MenuGenerator
    {
        ...
        public static void OnLoad()
        {
            ...
            harassMenu.AddManaLimiter(Enumerations.Skills.Q, "haras");
            harassMenu.AddManaLimiter(Enumerations.Skills.E, "haras");
            harassMenu.AddSeparator();
            harassMenu.AddSkill(Enumerations.Skills.Q, "haras");
            harassMenu.AddSkill(Enumerations.Skills.E, "haras");
            harassMenu.AddSeparator();
