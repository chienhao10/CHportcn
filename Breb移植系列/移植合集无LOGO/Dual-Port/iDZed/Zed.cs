...
namespace iDZed
{
    ...
    internal static class Zed
    {
        ...
        private static void InitMenu()
        {
            ...
            comboMenu.Add("com.idz.zed.combo.useqpred", new CheckBox("Q 预判: On = 慢, off = 快", false));
            comboMenu.Add("com.idz.zed.combo.usew", new CheckBox("使用 W"));
            comboMenu.Add("com.idz.zed.combo.usee", new CheckBox("使用 E"));
            comboMenu.Add("com.idz.zed.combo.user", new CheckBox("使用 R"));
            comboMenu.Add("com.idz.zed.combo.swapw", new CheckBox("替换 W 接近目标", false));
            comboMenu.Add("com.idz.zed.combo.swapr", new CheckBox("切换 R 击杀"));
            comboMenu.Add("com.idz.zed.combo.mode", new ComboBox("连招 模式", 0, "线形", "三角"));

            harassMenu = Menu.AddSubMenu(":: 骚扰", "com.idz.zed.harass");
            harassMenu.Add("com.idz.zed.harass.useHarass", new CheckBox("使用 骚扰"));
            harassMenu.Add("fast.harass", new CheckBox("Q 预判: On = 慢, off = 快", false));
            harassMenu.Add("com.idz.zed.harass.harassMode", new ComboBox("骚扰 模式", 0, "W-E-Q"));

            lastHitMenu = Menu.AddSubMenu(":: 尾兵", "com.idz.zed.lasthit");
            lastHitMenu.Add("com.idz.zed.lasthit.useQ", new CheckBox("使用 Q 尾兵"));
            lastHitMenu.Add("com.idz.zed.lasthit.useE", new CheckBox("使用 E 尾兵"));

            laneclearMenu = Menu.AddSubMenu(":: 清线", "com.idz.zed.laneclear");
            laneclearMenu.Add("com.idz.zed.laneclear.useQ", new CheckBox("使用 Q"));
            laneclearMenu.Add("com.idz.zed.laneclear.qhit", new Slider("最低小兵使用 Q", 3, 1, 10));
            laneclearMenu.Add("com.idz.zed.laneclear.useE", new CheckBox("使用 E 清线"));
            laneclearMenu.Add("com.idz.zed.laneclear.ehit", new Slider("最低小兵使用 E", 3, 1, 10));

            drawMenu = Menu.AddSubMenu(":: 线圈", "com.idz.zed.drawing");
            foreach (var slot in _spells.Select(entry => entry.Key))
            {
                drawMenu.Add("com.idz.zed.drawing.draw" + GetStringFromSpellSlot(slot),
                    new CheckBox("显示 " + GetStringFromSpellSlot(slot) + " 范围"));
            }
            drawMenu.Add("drawShadows", new CheckBox("显示 影子"));

            fleeMenu = Menu.AddSubMenu(":: 逃跑", "com.idz.zed.flee");
            fleeMenu.Add("fleeActive", new KeyBind("逃跑按键", false, KeyBind.BindTypes.PressToggle, 'P'));
            fleeMenu.Add("autoEFlee", new CheckBox("逃跑时自动 E"));

            miscMenu = Menu.AddSubMenu(":: 杂项", "com.idz.zed.misc");
            miscMenu.Add("energyManagement", new CheckBox("使用 能量管理器"));
            miscMenu.Add("safetyChecks", new CheckBox("替换影子时检查安全"));
            miscMenu.Add("com.idz.zed.misc.hitchance",
                new ComboBox("Q 命中率", 2, "低", "中", "高", "非常高"));
            miscMenu.Add("checkQWE", new CheckBox("连招前检查其他技能"));
        }
