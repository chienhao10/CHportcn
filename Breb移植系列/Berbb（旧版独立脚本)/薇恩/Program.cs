    ...
    public static class Program
    {
        ...
        static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (menuKey)
            {
                if (UseRBool)
                {
                    Drawing.DrawText(x, y, Color.DeepSkyBlue, "自动R? : " + UseRBool);
                }
                else
                {
                    Drawing.DrawText(x, y, Color.DarkGray, "自动R? : " + UseRBool);
                }

                if (dontaa)
                {
                    Drawing.DrawText(x, y + 25, Color.DeepSkyBlue, "R时不平A? : " + dontaa);
                }
                else
                {
                    Drawing.DrawText(x, y + 25, Color.DarkGray, "R时不平A? : " + dontaa);
                }
            }
        ...
        private static void InitMenu()
        {
            ...
            {
                ESettings.Add("stun" + enemy.ChampionName, new CheckBox("对: " + enemy.ChampionName + "定墙?"));
            }
            ESettings.AddSeparator();
            ...
            ItemMenu.Add("lowerHeal", new Slider("低于 X 血量使用治疗 :", 15, 0, 100));
            ...
            {
                ItemMenu.Add("MikaelsAlly" + ally.ChampionName, new CheckBox("对: " + ally.ChampionName + "使用米凯尔?"));
            }
            ItemMenu.AddSeparator();
