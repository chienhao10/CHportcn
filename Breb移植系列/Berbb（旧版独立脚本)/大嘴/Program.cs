...
namespace KogMaw
{
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            R = new Spell.Skillshot(SpellSlot.R, 1800, SkillShotType.Circular, 1200, int.MaxValue, 120);            R = new Spell.Skillshot(SpellSlot.R, 1260, SkillShotType.Circular, 1500, int.MaxValue, 225);
