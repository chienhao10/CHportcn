...
namespace NechritoRiven
{
    internal class Logic
    {
        ...
        {
            get { return Program.Player.HasBuff("RivenFengShuiEngine") ? 330 : 265; }
        }
        ...
        public static int Item
        {
            get
            {
                return Items.CanUseItem(3077) && Items.HasItem(3077)
                    ? 3077
                    : Items.CanUseItem(3074) && Items.HasItem(3074) ? 3074 : 0;
            }
        }

        public static bool InWRange(AttackableUnit t)
        {
            return t != null && t.IsValidTarget(WRange);
        }
        ...
        {
            if (_forceQ && _qtarget != null &&
                _qtarget.IsValidTarget(Spells._e.Range + Program.Player.BoundingRadius + 70) &&
                Spells._q.IsReady())
